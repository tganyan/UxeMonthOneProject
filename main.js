...
$(document).ready(function(){
  ...
  // Takes the width of the window and determines where we should hide/show the panel ID.
  var width = null;
  ...
  // Function for displaying the events.
  function Search(){
  ...
  // Calls the search function when user clicks the submit button.
  $("#searchSubmit").click(function(){
    Search();
  });

  // Calls the search function when user presses enter.
